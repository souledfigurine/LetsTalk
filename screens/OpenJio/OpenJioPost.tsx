...
type Props = NativeStackScreenProps<RootStackParamList, "OpenJioPost">; //current directory

const OpenJioPost: React.FC<Props> = ({ navigation: { navigate } }) => {
